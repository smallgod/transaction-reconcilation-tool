...
@Table(name = "linked_entity1")// these table names need to be created on the fly

public class Linked extends BaseModel implements Auditable, Processeable, TxnRecordIF, Serializable {
    
    private static final long serialVersionUID = -4683438326234871299L;
...
//    
    ...
    private Linked(String reconIDValue, String transactionStatuses, String comments, String masterFileRecords, boolean isRecordFoundInAllFiles, boolean isRecordFoundInMasterFile) {
